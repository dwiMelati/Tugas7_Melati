const products = [
    ...
    },
    {
      ...
      image:
        "../aset/7.webp",
      price: "Rp.14.779.000",
      desc: ["Stand Mixer","Untuk membuat roti,cake,kue","Made in USA","Garansi 3 tahun","l ProdukDaya Listrik : 220V, 50Hz, 300 Watt","WattKapasitas Bowl : 4,8 Liter"]},
    {
      id: 8,
  ...
  function card(product) {
    ...
    buyButton.addEventListener("click", () => {
      confirm("Pesanan anda sedang di proses");
    });
    ...
    commentButton.textContent = "Coment";
    commentButton.addEventListener("click", () => {
      prompt("Silahkan kasi pendapat");
    });
    figcaption.appendChild(h1);
    figcaption.appendChild(ul);
    figcaption.appendChild(h2);
    figcaption.appendChild(buyButton);
    figcaption.appendChild(cartButton);
    figcaption.appendChild(commentButton);
